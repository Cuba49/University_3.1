...
namespace lab2.Models
{
    public class Menu
    {
        ...
        public void StartDialog()
        {
            ...
            m_Controller.InitializeCombinations(rndNumbers[0], rndNumbers[1], rndNumbers[2], rndNumbers[3]);
            Console.WriteLine($"Generated numbers: {rndNumbers[0]}, {rndNumbers[1]}, {rndNumbers[2]}, {rndNumbers[3]}");
